  ...
  return (
    <Stack direction="column" spacing="8px">
      <Typography variant="h5">
        <span style={{ color: getDeploymentStatusColor('Invited') }}>Invited</span>:
      ...
      <Typography variant="h5">
        <span style={{ color: getDeploymentStatusColor('Running') }}>Running</span>:
        All the devices have been deployed and started the data collection.
      </Typography>
      <Typography variant="h5">
        <span style={{ color: getDeploymentStatusColor('Stopped') }}>Stopped</span>:
